...
class Setup
{
    ...
    /**
     * Marker file lives next to the module's own migrations, e.g.
     * modules/registrars/openprovider/migrations/.last_checked so the
     * throttle is per module install and needs no new DB storage.
     */
