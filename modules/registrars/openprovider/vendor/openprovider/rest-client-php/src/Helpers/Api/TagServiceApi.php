...
class TagServiceApi
{
     ...
     * Create tag
     *
     * @param  \Openprovider\Api\Rest\Client\Helpers\Model\HelperstagTag $body body (required)
     *
     * @throws \Openprovider\Api\Rest\Client\Helpers\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * Create tag
     *
     * @param  \Openprovider\Api\Rest\Client\Helpers\Model\HelperstagTag $body (required)
     *
