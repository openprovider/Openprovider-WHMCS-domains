...
class StatisticsApi
{
     ...
     * @return \Openprovider\Api\Rest\Client\Person\Model\StatisticsGetStatisticsResponse|\Openprovider\Api\Rest\Client\Person\Model\ErrorError
     */
     ...
     * @throws \InvalidArgumentException
     * @return array of \Openprovider\Api\Rest\Client\Person\Model\StatisticsGetStatisticsResponse|\Openprovider\Api\Rest\Client\Person\Model\ErrorError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStatisticsWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Openprovider\Api\Rest\Client\Person\Model\StatisticsGetStatisticsResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Openprovider\Api\Rest\Client\Person\Model\StatisticsGetStatisticsResponse', []),
            ...
            $returnType = '\Openprovider\Api\Rest\Client\Person\Model\StatisticsGetStatisticsResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Openprovider\Api\Rest\Client\Person\Model\StatisticsGetStatisticsResponse',
    ...
    {
        return $this->getStatisticsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function getStatisticsRequest()
    {
        ...
        $resourcePath = '/v1beta/resellers/statistics';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
