...
class SettingsApi
{
    ...
    public function getSettingsWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Openprovider\Api\Rest\Client\Person\Model\SettingsGetSettingsResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Openprovider\Api\Rest\Client\Person\Model\SettingsGetSettingsResponse', []),
            ...
            $returnType = '\Openprovider\Api\Rest\Client\Person\Model\SettingsGetSettingsResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Openprovider\Api\Rest\Client\Person\Model\SettingsGetSettingsResponse',
