...
class TransactionApi
{
     ...
     */
    public function listTransactions($limit = null, $offset = null, $order = null, $order_by = null, $start_creation_date = null, $end_creation_date = null, $filter_for_subject = null)
    {
        list($response) = $this->listTransactionsWithHttpInfo($limit, $offset, $order, $order_by, $start_creation_date, $end_creation_date, $filter_for_subject);
        return $response;
    }
     ...
     */
    public function listTransactionsWithHttpInfo($limit = null, $offset = null, $order = null, $order_by = null, $start_creation_date = null, $end_creation_date = null, $filter_for_subject = null)
    {
        $request = $this->listTransactionsRequest($limit, $offset, $order, $order_by, $start_creation_date, $end_creation_date, $filter_for_subject);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Openprovider\Api\Rest\Client\Billing\Model\TransactionListTransactionsResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Openprovider\Api\Rest\Client\Billing\Model\TransactionListTransactionsResponse', []),
            ...
            $returnType = '\Openprovider\Api\Rest\Client\Billing\Model\TransactionListTransactionsResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Openprovider\Api\Rest\Client\Billing\Model\TransactionListTransactionsResponse',
    ...
    {
        return $this->listTransactionsAsyncWithHttpInfo($limit, $offset, $order, $order_by, $start_creation_date, $end_creation_date, $filter_for_subject)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function listTransactionsRequest($limit = null, $offset = null, $order = null, $order_by = null, $start_creation_date = null, $end_creation_date = null, $filter_for_subject = null)
    {
        ...
        $resourcePath = '/v1beta/transactions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($filter_for_subject !== null) {
            $queryParams['filter_for_subject'] = ObjectSerializer::toQueryValue($filter_for_subject);
        }
