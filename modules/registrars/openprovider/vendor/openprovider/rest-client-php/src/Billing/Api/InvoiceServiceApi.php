...
class InvoiceServiceApi
{
     ...
     */
    public function listInvoices($limit = null, $offset = null, $order = null, $order_by = null, $start_creation_date = null, $end_creation_date = null)
    {
        list($response) = $this->listInvoicesWithHttpInfo($limit, $offset, $order, $order_by, $start_creation_date, $end_creation_date);
        return $response;
    }
     ...
     */
    public function listInvoicesWithHttpInfo($limit = null, $offset = null, $order = null, $order_by = null, $start_creation_date = null, $end_creation_date = null)
    {
        $request = $this->listInvoicesRequest($limit, $offset, $order, $order_by, $start_creation_date, $end_creation_date);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Openprovider\Api\Rest\Client\Billing\Model\InvoiceListInvoicesResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Openprovider\Api\Rest\Client\Billing\Model\InvoiceListInvoicesResponse', []),
            ...
            $returnType = '\Openprovider\Api\Rest\Client\Billing\Model\InvoiceListInvoicesResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Openprovider\Api\Rest\Client\Billing\Model\InvoiceListInvoicesResponse',
    ...
    {
        return $this->listInvoicesAsyncWithHttpInfo($limit, $offset, $order, $order_by, $start_creation_date, $end_creation_date)
            ->then(
                function ($response) {
                    return $response[0];
                }
