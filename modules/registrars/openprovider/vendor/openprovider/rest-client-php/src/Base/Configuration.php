...
namespace Openprovider\Api\Rest\Client\Base;
 ...
 *
 * @category Class
 * @package  Openprovider\Api\Rest\Client\Base
...
class Configuration
{
    ...
    {
        $report  = 'PHP SDK (Openprovider\Api\Rest\Client\Base) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.0.0-beta' . PHP_EOL;
