...
class DomainSyncController extends BaseController
{
     ...
     */
    public function __construct(Core $core, api_domain $api_domain, Domain $domain, OpenProvider $openprovider)
    {
    ...
    public function sync($params)
    {
        ...
        try {
            ...
            $op_domain_result = $api->retrieveDomainRequest($this->api_domain, true);
