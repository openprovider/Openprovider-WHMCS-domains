...
if (!function_exists("op_addConsentField")) {
    function op_addConsentField(array &$additionaldomainfields, string $tld, bool $required = false): void
    {
        ...
        $additionaldomainfields[$tld][] = array(
            ...
            "DisplayName" => $ADDONLANG["openprovider"]["consentForPublishing"],
...
$additionaldomainfields[".us"][] = array(
    "Name" => "Nexus Category",
    "DisplayName" => $ADDONLANG["openprovider"]["ustldnexuscat"],
...
$additionaldomainfields[".us"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["ustldapppurpose"],
...
$additionaldomainfields[".travel"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["travelUIN"],
    "LangVar" => "travelUIN",
    "Type" => "text",
    "Required" => true,
    "op_location" => "customerExtensionAdditionalData",
...
$additionaldomainfields[".xxx"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["xxxCommunityId"],
...
$additionaldomainfields[".xxx"][] = array(
    "Name" => "Defensive",
    "DisplayName" => $ADDONLANG["openprovider"]["xxxDefensive"],
...
$additionaldomainfields[".jobs"][] = array(
    "Name" => "Website",
    "DisplayName" => $ADDONLANG["openprovider"]["jobsWebsite"],
    "LangVar" => "jobsWebsite",
    "Type" => "text",
    "Required" => true,
    "op_location" => "customerExtensionAdditionalData",
...
$additionaldomainfields[".jobs"][] = array(
    "Name" => "Industry Class",
    "DisplayName" => $ADDONLANG["openprovider"]["jobsIndustryClass"],
...
$additionaldomainfields[".jobs"][] = array(
    "Name" => "Admin Type",
    "DisplayName" => $ADDONLANG["openprovider"]["jobsAdminType"],
...
$additionaldomainfields[".jobs"][] = array(
    "Name" => "Contact Title",
    "DisplayName" => $ADDONLANG["openprovider"]["jobsContactTitle"],
...
$additionaldomainfields[".jobs"][] = array(
    "Name" => "HR Member",
    "DisplayName" => $ADDONLANG["openprovider"]["jobsHRMember"],
...
$additionaldomainfields[".aero"][] = array(
    "Name" => ".aero ID",
    "DisplayName" => $ADDONLANG["openprovider"]["aeroEnsAuthId"],
...
$additionaldomainfields[".aero"][] = array(
    "Name" => ".aero ENS key",
    "DisplayName" => $ADDONLANG["openprovider"]["aeroEnsKey"],
    "LangVar" => "aeroEnsKey",
    "Type" => "text",
    "Required" => true,
    "op_location" => "customerExtensionAdditionalData",
...
$additionaldomainfields[".pt"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["ptIdentificationType"],
...
$additionaldomainfields[".pt"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["ptIdentificationNumber"],
    "LangVar" => "ptIdentificationNumber",
    "Type" => "text",
    "Size" => "30",
    "Required" => true,
...
$additionaldomainfields[".it"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["vat"],
    "LangVar" => "vat",
    "Type" => "text",
    "Size" => "30",
    "Required" => false,
...
$additionaldomainfields[".it"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["socialSecurityNumber"],
...
$additionaldomainfields[".ru"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["ruMobilePhoneNumber"],
...
$additionaldomainfields[".ru"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["ruLegalAddressCyrillic"],
...
$additionaldomainfields[".ru"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["ruPostalAddressCyrillic"],
...
$additionaldomainfields[".ru"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["ruTaxPayerNumber"],
...
$additionaldomainfields[".ru"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["ruFirstNameCyrillic"],
...
$additionaldomainfields[".ru"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["ruMiddleNameCyrillic"],
...
$additionaldomainfields[".ru"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["ruLastNameCyrillic"],
...
$additionaldomainfields[".ru"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["ruFirstNameLatin"],
...
$additionaldomainfields[".ru"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["ruMiddleNameLatin"],
...
$additionaldomainfields[".ru"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["ruLastNameLatin"],
...
$additionaldomainfields[".ru"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["ruPassportSeries"],
...
$additionaldomainfields[".ru"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["ruPassportNumber"],
...
$additionaldomainfields[".ru"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["ruPassportIssuer"],
...
$additionaldomainfields[".ru"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["ruPassportIssueDate"],
...
$additionaldomainfields[".ru"][] = array(
    "Name" => "Birth Date",
    "DisplayName" => $ADDONLANG["openprovider"]["ruBirthDate"],
    "LangVar" => "ruBirthDate",
    "Type" => "text",
    "Required" => true,
    "op_location" => "customerExtensionAdditionalData",
...
$additionaldomainfields[".ru"][] = array(
    "Name" => "Company Name Latin",
    "DisplayName" => $ADDONLANG["openprovider"]["ruCompanyNameLatin"],
    "LangVar" => "ruCompanyNameLatin",
    "Type" => "text",
    "op_location" => "customerExtensionAdditionalData",
...
$additionaldomainfields[".ro"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["roCompanyRegistrationNumber"],
...
$additionaldomainfields[".ro"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["roSocialSecurityNumber"],
...
$additionaldomainfields[".es"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["esIdentificationType"],
...
$additionaldomainfields[".es"][] = array(
    "Name" => "Número de identificación",
    "DisplayName" => $ADDONLANG["openprovider"]["esIdentificationNumber"],
    "Type" => "text",
    "Size" => "30",
    "Required" => true,
    "op_location" => "customerAdditionalData",
...
$additionaldomainfields[".es"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["esAnnexAcceptance"],
...
$additionaldomainfields[".ae"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["aeAcceptance"],
...
$additionaldomainfields[".se"][] = array(
    "Name" => "Owner type",
    "DisplayName" => $ADDONLANG["openprovider"]["seIdentificationType"],
...
$additionaldomainfields[".se"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["seIdentificationNumber"],
...
$additionaldomainfields[".se"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["iisseAcceptance"],
...
$additionaldomainfields[".sg"][] = array(
    "Name" => "Company Registration Number",
    "DisplayName" => $ADDONLANG["openprovider"]["companyRegistrationNumber"],
...
$additionaldomainfields[".hu"][] = array(
    "Name" => "VAT",
    "DisplayName" => $ADDONLANG["openprovider"]["huVat"],
    "LangVar" => "huVat",
    "Type" => "text",
    "op_location" => "customerExtensionAdditionalData",
    "op_name" => "vat"
...
$additionaldomainfields[".hu"][] = array(
    "Name" => "Passportnumber",
    "DisplayName" => $ADDONLANG["openprovider"]["huPassportNumber"],
...
$additionaldomainfields[".id.au"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["idauEligibilityTypeRelationship"],
...
$additionaldomainfields[".id.au"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["idauEligibilityType"],
...
$additionaldomainfields[".ca"][] = array(
    "Name" => "Legal Type",
    "DisplayName" => $ADDONLANG["openprovider"]["caLegalType"],
    "LangVar" => "caLegalType",
    "Type" => "dropdown",
...
$additionaldomainfields[".com"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["comIdnScript"],
...
$additionaldomainfields[".org"][] = array(
    "Name" => "Internationalized domain name Script (only for IDN domains)",
    "DisplayName" => $ADDONLANG["openprovider"]["orgIdnScript"],
...
$additionaldomainfields[".voto"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["votoAcceptance"],
...
$additionaldomainfields[".vote"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["voteAcceptance"],
...
$additionaldomainfields[".scot"][] = array(
    "Name" => "Intended Use",
    "DisplayName" => $ADDONLANG["openprovider"]["scotIntendedUse"],
...
$additionaldomainfields[".scot"][] = array(
    "Name" => "Internationalized domain name Script (only for IDN domains)",
    "DisplayName" => $ADDONLANG["openprovider"]["scotIdnScript"],
...
$additionaldomainfields[".scot"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["scotDomainNameVariants"],
...
$additionaldomainfields[".pl"][] = array(
    "Name" => "Intended Use",
    "DisplayName" => $ADDONLANG["openprovider"]["plIntendedUse"],
...
$additionaldomainfields[".xn--ngbc5azd"][] = array(
    "Name" => "Internationalized domain name Script (only for IDN domains)",
    "DisplayName" => $ADDONLANG["openprovider"]["idnScript"],
    "LangVar" => "idnScript",
    "Type" => "dropdown",
    "Options" => "ar - Arabic",
    "Required" => true,
...
$additionaldomainfields[".swiss"][] = array(
    "Name" => "Intended Use",
    "DisplayName" => $ADDONLANG["openprovider"]["swissIntendedUse"],
...
$additionaldomainfields[".radio"][] = array(
    "Name" => "Intended Use",
    "DisplayName" => $ADDONLANG["openprovider"]["intendedUse"],
    "LangVar" => "intendedUse",
    "Type" => "text",
    "Required" => true,
    "op_location" => "domainAdditionalData",
...
$additionaldomainfields[".law"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["lawAccreditationId"],
...
$additionaldomainfields[".law"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["lawAccreditationBody"],
...
$additionaldomainfields[".law"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["lawAccreditationYear"],
...
$additionaldomainfields[".law"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["lawJurisdictionCC"],
...
$additionaldomainfields[".law"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["lawJurisdictionSP"],
...
$additionaldomainfields[".law"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["lawAcceptance"],
...
$additionaldomainfields[".fi"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["fiOrgType"],
    "LangVar" => "fiOrgType",
    "Type" => "dropdown",
    "Required" => true,
...
$additionaldomainfields[".fi"][] = array(
    "Name" => "Company Registration Number",
    "DisplayName" => $ADDONLANG["openprovider"]["fiCompanyRegistrationNumber"],
...
$additionaldomainfields[".fi"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["fiPassportNumber"],
...
$additionaldomainfields[".fi"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["fiSocialSecurityNumber"],
...
$additionaldomainfields[".fi"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["fiBirthDate"],
    "LangVar" => "fiBirthDate",
    "Type" => "text",
    "Size" => "10",
    "Required" => false,
...
$additionaldomainfields[".nu"][] = array(
    "Name" => "Owner type",
    "DisplayName" => $ADDONLANG["openprovider"]["nuIdentificationType"],
...
$additionaldomainfields[".nu"][] = array(
    "Name" => "Identification number",
    "DisplayName" => $ADDONLANG["openprovider"]["nuIdentificationNumber"],
...
$additionaldomainfields[".nu"][] = array(
    "Name" => "By registering this domain name, I acknowledge and accept the <a href=\"https://internetstiftelsen.se/app/uploads/2024/05/nu-terms-and-conditions-2024-06-03.pdf\" target=\"_blank\">.nu registration agreement</a>",
    "DisplayName" => $ADDONLANG["openprovider"]["iisseAcceptance"],
    "LangVar" => "iisseAcceptance",
    "Type" => "tickbox",
    "Required" => true,
...
$additionaldomainfields[".eu"][] = [
    "Name" => "Entity Type",
    "DisplayName" => $ADDONLANG["openprovider"]["euTldEntityType"],
...
$additionaldomainfields[".eu"][] = [
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["eu_country_of_citizenship"],
...
$additionaldomainfields[".dk"][] = array(
    ...
    "DisplayName" => $ADDONLANG["openprovider"]["dkAcceptance"],
