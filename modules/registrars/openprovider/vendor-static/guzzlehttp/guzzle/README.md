...
| 4.x     | EOL (2016-10-31)    | `guzzlehttp/guzzle` | `GuzzleHttp6` | [v4][guzzle-4-repo] | N/A                 | No    | >=5.4,<7.0   |
| 5.x     | EOL (2019-10-31)    | `guzzlehttp/guzzle` | `GuzzleHttp6` | [v5][guzzle-5-repo] | [v5][guzzle-5-docs] | No    | >=5.4,<7.4   |
| 6.x     | EOL (2023-10-31)    | `guzzlehttp/guzzle` | `GuzzleHttp6` | [v6][guzzle-6-repo] | [v6][guzzle-6-docs] | Yes   | >=5.5,<8.0   |
| 7.x     | Latest              | `guzzlehttp/guzzle` | `GuzzleHttp6` | [v7][guzzle-7-repo] | [v7][guzzle-7-docs] | Yes   | >=7.2.5,<8.5 |
