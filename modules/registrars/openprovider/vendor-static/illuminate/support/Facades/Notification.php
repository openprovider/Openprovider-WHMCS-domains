...
use Illuminate\Support6\Testing\Fakes\NotificationFake;

/**
 * @method static void send(\Illuminate\Support6\Collection|array|mixed $notifiables, $notification)
 * @method static void sendNow(\Illuminate\Support6\Collection|array|mixed $notifiables, $notification)
 ...
 * @method static \Illuminate\Support6\Collection sent(mixed $notifiable, string $notification, callable $callback = null)
...
class Notification extends Facade
{
     ...
     *
     * @return \Illuminate\Support6\Testing\Fakes\NotificationFake
     */
