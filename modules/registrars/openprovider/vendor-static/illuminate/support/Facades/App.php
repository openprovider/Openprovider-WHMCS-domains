 ...
 * @method static \Illuminate\Support6\ServiceProvider register(\Illuminate\Support6\ServiceProvider|string $provider, bool $force = false)
 * @method static void registerDeferredProvider(string $provider, string $service = null)
 * @method static \Illuminate\Support6\ServiceProvider resolveProvider(string $provider)
 ...
 * @method static array getProviders(\Illuminate\Support6\ServiceProvider|string $provider)
