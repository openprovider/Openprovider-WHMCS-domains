 ...
 * @method static \Illuminate\Routing\Route substituteBindings(\Illuminate\Support6\Facades\Route $route)
 * @method static void substituteImplicitBindings(\Illuminate\Support6\Facades\Route $route)
