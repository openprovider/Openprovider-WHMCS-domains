...
foreach($vars['cart']['domains'] as $domain)
{
  ...
  foreach($domain['fields'] as $field)
  {
      ...
      {
        switch ($f) {
        case 1: $fieldData['field'] = $field;
        break;
        case 2: $fieldData['value'] = $field;
        break;
      }
    }
  }
  ...
  foreach($data as $domain => $fields){
    ...
    {
      switch ($fields['field']) {
        case 'companyRegistrationNumber': $name = $_LANG['esIdentificationCompany'];
          break;
        case 'passportNumber':  $name = $_LANG['esIdentificationPassport'];
        break;
      }
