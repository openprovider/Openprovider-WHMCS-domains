...
| restapi_url_sandbox             | string: "https://api.sandbox.openprovider.nl" | The API endpoint which the module will use to connect to your Openprovider Sandbox (CTE) account. You can create a sandbox account at https://cp.sandbox.openprovider.nl/signup. |
